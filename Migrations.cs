...
namespace WebAdvanced.Sitemap {
    public class Migrations : DataMigrationImpl {
        #region Methods
        public int Create() {
            SchemaBuilder.CreateTable("SitemapRouteRecord",
                table => table.Column<int>("Id",
                        col => col.PrimaryKey()
                            .Identity())
                    .Column<string>("Slug")
            ...
            SchemaBuilder.CreateTable("SitemapSettingsRecord",
                table => table.Column<int>("Id",
                        col => col.PrimaryKey()
                            .Identity())
                    ...
                    .Column<int>("Priority"));
            SchemaBuilder.CreateTable("SitemapCustomRouteRecord",
                table => table.Column<int>("Id",
                        col => col.PrimaryKey()
                            .Identity())
